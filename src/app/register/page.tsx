      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-panel rounded-2xl p-6 border border-slate-800 shadow-2xl relative space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] text-slate-500 uppercase font-mono">or register with email</span>
            <div className="flex-1 h-px bg-slate-800" />
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-pink-600 to-indigo-600 hover:from-pink-500 hover:to-indigo-500 text-white font-bold text-xs shadow-lg glow-bkash flex items-center justify-center gap-2 transition-all mt-1"
            >
              {loading ? (
